    ...
    void Update()
    {
        if (gameManager.gameStart)
        {
            ...
            if (Input.GetKeyDown(KeyCode.A) || Input.GetKeyUp(KeyCode.S) || Input.GetKeyDown(KeyCode.D) || Input.GetKeyDown(KeyCode.S))
            {
                ...
                //カメラコントロールWASD
                //if (Input.GetKeyDown(KeyCode.A)) focusNum = 1;
                //else if (Input.GetKeyDown(KeyCode.W)) focusNum = 2;
                //else if (Input.GetKeyDown(KeyCode.D)) focusNum = 3;
                //else if (Input.GetKeyDown(KeyCode.S)) focusNum = 0;
